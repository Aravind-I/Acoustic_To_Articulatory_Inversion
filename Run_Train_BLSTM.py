...
#for ss in np.arange(0,len(Trainsubs)):
    ...
    '''
    L1a=TimeDistributed(Dense(NoUnits))(mdninput_Lstm)
    ...
    '''
    L1a=Bidirectional(LSTM(NoUnits, return_sequences=True,activation='tanh'))(mdninput_Lstm)
    L1b=BatchNormalization(axis=-1)(L1a)
    L1=Dropout(0.2)(L1b)
    L2a=Bidirectional(LSTM(NoUnits, return_sequences=True,activation='tanh'))(L1)
    L2b=BatchNormalization(axis=-1)(L2a)
    L2=Dropout(0.2)(L2b)
    L3a=Bidirectional(LSTM(NoUnits, return_sequences=True,activation='tanh'))(L2)
    ...
    OutFileName='BLSTM_SD_AAI_'+'Batch'+ str(BatchSize)+'_'+Sub+'_LSTMunits_'+str(NoUnits)+'_'
    fName=OutFileName
    print('..fitting model')
